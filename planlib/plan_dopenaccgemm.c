 ...
 */
void *makeDOPENACCGEMMPlan(data *i){   // <- Replace YOUR_NAME with the name of your module.
    Plan *p;     // <- Plan pointer, necessary to integrate with systemburn. Do not change.
    DOPENACCGEMM_DATA *ip;     // <- Change YOUR_TYPE with the name of your data type defined in the header file.
    ...
    if(p){      // <- Checking the Plan pointer was allocated. Do not change.
        ...
        p->fptr_initplan = &initDOPENACCGEMMPlan;         // <- Replace YOUR_NAME with the name of your module.
        p->fptr_execplan = &execDOPENACCGEMMPlan;         // <- Replace YOUR_NAME with the name of your module.
        p->fptr_killplan = &killDOPENACCGEMMPlan;         // <- Replace YOUR_NAME with the name of your module.
        p->fptr_perfplan = &perfDOPENACCGEMMPlan;
        p->name = DOPENACCGEMM;                           // <- Replace YOUR_NAME with the name of your module.
 ...
 */
void *killDOPENACCGEMMPlan(void *plan){   // <- Replace YOUR_NAME with the name of your module.
    ...
    free(local_data->A_buffer);
    free(local_data->B_buffer);
    free(local_data->C_buffer);
 ...
 */
int parseDOPENACCGEMMPlan(char *line, LoadPlan *output){  // <- Replace YOUR_NAME with the name of your module.
    output->input_data = get_sizes(line);
    output->name = DOPENACCGEMM;     // <- Replace YOUR_NAME with the name of your module.
...
char *PLAN_DOPENACC_DGEMM_ERRORS[] = {
    "ERROR message goes here"
};

plan_info DOPENACCGEMM_info = {
    "DOPENACCGEMM",     //DOPENACCGEMM
    NULL,     //YOUR_ERRORS (if applicable. If not, leave NULL.)
    0,     // Size of ^
    makeDOPENACCGEMMPlan,
    parseDOPENACCGEMMPlan,
    execDOPENACCGEMMPlan,
    initDOPENACCGEMMPlan,
    killDOPENACCGEMMPlan,
    perfDOPENACCGEMMPlan,
